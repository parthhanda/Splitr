    ...
    <div className="flex flex-col pt-16">
      ...
      <section className="mt-20 pb-12 space-y-10 md:space-y-15 px-5">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          ...
          <h1 className="bg-gradient-to-r from-green-600 to-teal-500 text-transparent bg-clip-text pb-1 pr-2 tracking-tighter mx-auto max-w-6xl text-4xl font-extrabold md:text-8xl">
        ...
        <div className="container mx-auto max-w-5xl overflow-hidden rounded-xl shadow-xl">
          <div className="bg-gradient-to-r from-green-600 to-teal-500 p-1 aspect-[16/9]">
            <Image
              src="/hero.png"
              width={1280}
              height={720}
      ...
      <section id="features" className="bg-gray-50 py-20">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <h2 className="bg-gradient-to-r from-green-600 to-teal-500 text-transparent bg-clip-text pb-1 pr-2 tracking-tighter mt-2 text-3xl font-extrabold md:text-4xl">
