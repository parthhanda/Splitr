...
export const TESTIMONIALS = [
  {
    quote:
      "With Splitr, I finally stopped getting confused and stopped wasting unnecessary time thinking about who paid for what!",
    name: "Parth Handa",
    image: "/testimonials/Parth_pfp.jpg",
    role: "CEO - Leading MNC",
  },
  {
    quote:
      "The cleanest UI for expense splitting I've ever seen. Incredibly easy to use",
    name: "Manya Wadhwa",
    image: "/testimonials/Manya_pfp.jpg",
    role: "Business Analyst - McKinsey",
  },
  {
    quote:
      "Finally, an app that understands how group dynamics and shared bills actually work",
    name: "Pranjal Garg",
    image: "/testimonials/Pranjal_pfp.jpg",
    role: "Job Searcher",
  },
];